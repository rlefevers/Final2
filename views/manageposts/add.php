...
<div class="container">
  ...
  <div class="row">
      <div class="span8">
        <form id="addpost" action="<?php echo BASE_URL?>manageposts/<?php echo $task?>" method="post" onsubmit="return validateForm()">
          <label>Title</label>
...
function validateForm() {
  ...
  if (title == "") {
    alert("You must have a post title");
    return false;
  }
	var date = document.forms["addpost"]["date"].value;
  if (date == "") {
    alert("You must select a date");
    return false;
  }
	var category = document.forms["addpost"]["category"].value;
  if (category == "") {
